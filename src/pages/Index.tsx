...
import UltraWowHeroSection from '@/components/landing/UltraWowHeroSection';
import DemoVideoSection from '@/components/landing/DemoVideoSection';

import TokenomicsSection from '@/components/landing/TokenomicsSection';
import UltraSocialProofSection from '@/components/landing/UltraSocialProofSection';
  ...
  return (
    <div className="index-page-container relative w-full">
      ...
      <main className="relative z-10 w-full">
        <SectionErrorBoundary sectionName="Ultra Wow Hero">
          <UltraWowHeroSection />
        </SectionErrorBoundary>
        <SectionErrorBoundary sectionName="Demo Video">
          <DemoVideoSection />
        </SectionErrorBoundary>
