...
class SolanaTokenService {
  ...
  private readonly DEMO_TRANSACTIONS: TransactionData[] = [
    {
      signature: '5KJp7z8mN3qR4vL2wX9yB1cE6fH8jK9mP2qS4tU7vW8xY1zA2bC3dE4fG5hI6jK7lM8nO9pQ0rS1tU2vW3xY4zA',
      type: 'buy',
      amount: 1250,
      value: 30.625,
    ...
    {
      signature: '3dE4fG5hI6jK7lM8nO9pQ0rS1tU2vW3xY4zA5bC6dE7fG8hI9jK0lM1nO2pQ3rS4tU5vW6xY7zA8bC9dE0fG1h',
      type: 'sell',
      amount: 800,
      value: 19.6,
    ...
    {
      signature: '8hI9jK0lM1nO2pQ3rS4tU5vW6xY7zA8bC9dE0fG1hI2jK3lM4nO5pQ6rS7tU8vW9xY0zA1bC2dE3fG4hI5jK6l',
      type: 'buy',
      amount: 2000,
      value: 49.0,
   ...
   */
  async getRecentTransactions(tokenAddress: string, limit: number = 10): Promise<TransactionData[]> {
    try {
   ...
   */
  async getPriceHistory(tokenAddress: string, timeframe: '1h' | '24h' | '7d' | '30d' = '24h'): Promise<PriceHistory[]> {
    try {
      const response = await fetch(`${this.BIRDEYE_API}/history_price?address=${tokenAddress}&type=${timeframe}`, {
        headers: {
          'X-API-KEY': process.env.VITE_BIRDEYE_API_KEY || 'demo'
        }
      });
   ...
   */
  private async enrichTokenData(tokenAddress: string, baseData: Partial<TokenData>): Promise<TokenData> {
